            ...
            JSXOpeningElement: {
                enter(path) {
                    ...
                    if (key) {
                        ...
                        atrs.push(t.jSXAttribute(t.jSXIdentifier('wx:key'), t.stringLiteral(`${value}`)))
                    }

                    const jsx = t.jsxOpeningElement(t.jSXIdentifier(tag), [
                        t.jSXAttribute(t.jSXIdentifier('wx:for'), t.stringLiteral(`{{${that.object}}}`)),
                        t.jSXAttribute(t.jSXIdentifier('wx:for-item'), t.stringLiteral(`${that.item}`)),
                        t.jSXAttribute(t.jSXIdentifier('wx:for-index'), t.stringLiteral(`${that.index}`)),
                        ...atrs //继承父亲的属性
                    ])
